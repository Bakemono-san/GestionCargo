        ...
        <main class="hfull flex relative">
            ...
            <div class="flex-1 p-12 py-12 gap-12 flex flex-col">
                <div class="flex justify-between items-center">
                    ...
                    <button onclick="show()" class="px-4 py-1 flex justify-center items-center rounded-full bg-gray-700 gap-2 text-white ">
                ...
                <div>
                    <div class="flex gap-8">
                        ...
                        <button class="pb-4">Statistique</button>
                    </div>
                    <hr class="px-8">
                </div>
                ...
                <div class="inset-0 absolute w-full h-full bg-black bg-opacity-50 justify-center items-center hidden overlay z-10 transition-all duration-1000" onclick="hide()">
                </div>
